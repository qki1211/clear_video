...
/********************************************************************************************
//* Filename: 		AesEncryptionDisableAction.java
//* Revision: 		1.0
//* Author: 		
//* Created On: 	
//* Modified by: 	
//* Modified On: 	
//* 				
//* Description:    ACTION - Deactivate AES Encryption
//* 				
//* 				
//* ******************************************************************************************
//* 				
...
public class AesEncryptionDisableAction extends GenericSwingAction {
	
	private static final Logger log = LogManager.getLogger(AesEncryptionDisableAction.class);
	
	/**
	 * Constructor Triggers Action to Fire!
	 * @param inputs
	*/
	public AesEncryptionDisableAction(Object[] inputs) {
	...
	*/
	protected boolean execute(Object[] inputs) throws Exception {
		...
		if (ConstantsVideoApplication._DEBUG_ACTION_MVC) { 
			log.debug("AESEncryptionDisableAction - ENTERING execute()");
		}
		
	    String cmd = (String)inputs[0];
	    
	    if (cmd.equalsIgnoreCase(ConstantsElements.BUTTON_LABELS[15])) {
	    	 this.disable();
	    }
	    else {
	        if (ConstantsVideoApplication._DEBUG_ACTION_MVC) { 
	...
	*/
	private void disable() throws Exception {
		...
		if (ConstantsVideoApplication._DEBUG_ACTION_MVC) { 
			log.debug("AESEncryptionDisableAction - ENTERING disable()");
		}
		...
		if (ConstantsVideoApplication._DEBUG_ACTION_MVC) { 
			log.debug("AESEncryptionDisableAction - EXITING disable()");
		}
	}
}
