...
/********************************************************************************************
//* Filename: 		WebcamDefaultDevice.java
//* Revision: 		1.0
//* Author: 		
//* Created On: 	
//* Modified by: 	
//* Modified On: 	
//* 				
//* Description:    WRAPPER IMPLEMENTATION - SARXOS WEBCAM DEFAULT DEVICE
//* 				
//* 				
//* ******************************************************************************************
//* 				
...
public class WebcamDefaultDevice implements WebcamDevice, BufferAccess, Runnable, WebcamDevice.FPSSource {
	 ...
	 * Logger.
	 */
	private static Logger LOG = LogManager.getLogger(WebcamDefaultDevice.class);
	...
	public ByteBuffer getImageBytes() {
		...
		//LOG.warn("Webcam grabber get image pointer");
		...
		//LOG.warn("Webcam device get buffer, read {} bytes"+ length);
	...
	public void getImageBytes(ByteBuffer target) {
		...
		//LOG.warn("Webcam device read buffer {} bytes"+ minSize);
