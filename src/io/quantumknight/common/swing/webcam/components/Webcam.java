...
//* Modified On: 	
//* 				
//* Description:    WRAPPER IMPLEMENTATION - SARXOS WEBCAM
//* 				
//* 				
//* ******************************************************************************************
//* 				
...
import io.quantumknight.common.swing.webcam.components.WebcamDevice.Configurable;
import io.quantumknight.common.swing.webcam.components.WebcamUpdater.DefaultDelayCalculator;
import io.quantumknight.common.swing.webcam.components.WebcamUpdater.DelayCalculator;
import io.quantumknight.common.swing.webcam.components.driver.WebcamDefaultDevice;
import io.quantumknight.common.swing.webcam.components.driver.WebcamDefaultDriver;
import io.quantumknight.common.swing.webcam.state.WebcamSingleton;
...
public class Webcam {
	 ...
	 * Logger instance.
	 */
	private static Logger LOG = LogManager.getLogger(Webcam.class);
...
//			lock.unlock();
	...
	private void removeShutdownHook() {
		...
		if (hook != null) {
			try {
				...
				LOG.warn("Shutdown in progress, cannot remove hook");
			}
		}
	}
	...
	public static List<Webcam> getWebcams() throws WebcamException {
		...
		WebcamSingleton xcc = WebcamSingleton.getInstance();
		return xcc.getAttachedDevices();
	}
