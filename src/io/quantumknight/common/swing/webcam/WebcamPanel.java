...
import io.quantumknight.common.swing.webcam.components.WebcamEvent;
import io.quantumknight.common.swing.webcam.components.WebcamException;
import io.quantumknight.common.swing.webcam.components.WebcamExceptionHandler;
import io.quantumknight.common.swing.webcam.components.WebcamListener;
import io.quantumknight.common.swing.webcam.components.WebcamUtils;
...
public class WebcamPanel extends JPanel implements WebcamListener, PropertyChangeListener {
	 ...
	 * Logger.
	 */
	private static Logger LOG = LogManager.getLogger(WebcamPanel.class);
		...
		private class RepaintScheduler extends Thread {
			...
			public void run() {
				...
				try {
					...
					LOG.warn("Executor rejected paint update because of", e);
				}
			}
		}
